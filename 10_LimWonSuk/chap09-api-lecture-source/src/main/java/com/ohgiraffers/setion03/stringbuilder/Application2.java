...
public class Application2
{
    public static void main(String[] args)
    {
        ...
        /* 축전지, 용량 = capacity() : 용량(현재 버퍼의 크기)을 정수형으로 반환하는 메소드 (문자열 길이 + 16이 기본 용량) */
         ...
         * 둘 다 원본에 영향을 미친다.
         *  */
        System.out.println("delete() : " + sb2.delete(2, 5));				//jaracle -> 2 이상 5 미만
         ...
         * 원본에 영향을 미친다.
         * */
        System.out.println("insert() : " + sb2.insert(1, "vao")); // 1번 인덱스에 vao를 넣는다
        System.out.println("insert() : " + sb2.insert(0, "j"));
        /* 인덱스 번호가 문자열의 길이와 같은 경우 append()와 같은 역할을 한다. */
        System.out.println("insert() : " + sb2.insert(sb2.length(), "jdbc")); // 제일뒤에 jdbc를 붙인다
         ...
         * 원본에 영향을 미친다.
         * */
        System.out.println("reverse() :" + sb2.reverse()); // 원본 자체를 뒤집어서 나온다
