...
public class Application1 {
  public static void main(String[] args) {
    ...
    * */
    ...
    List list = new ArrayList(); // 부모타입 = 자식인스턴스 (업캐스팅) -> 많이 쓰는 형태
    ...
    System.out.println("before = " + before); // 반환값(기존요소)
    System.out.println("fruits = " + fruits);
    ...
    // 7) Collections.sort(List list) : 오름차순 정렬
